    ...
    return (
      <div>
        ...
        <form>
          ...
          <input name="nombre" type="text" placeholder="INGRESE SU NOMBRE" onChange={(ev) => { this.syncChanges(ev.target.value, 'apellido') }} />
          <p/>

          <label htmlFor="hobbie"> Hobbie: </label>
          <input name="nombre" type="text" placeholder="INGRESE SU HOBBIE FAVORITO" onChange={(ev) => { this.syncChanges(ev.target.value , 'hobbie')  }} />
          <p/>
